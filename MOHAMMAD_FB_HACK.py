...
def banner():
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: mohammad_hacker             |"
    print GL+"  |       Berdoa Dulu Sebelum Menggunakan       |"
    print WW+"  |        TEAM : Afghan CYBER ErRoR SyStEm            |"
         ...
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
              `-/+///..````..://+/-`
                ...
                \033[90;1mLife Of Programmer [N3Ro0X]\033[91;1m
             Powered by:\033[97m mohammad_hacker
      """
